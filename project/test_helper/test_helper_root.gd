...
func _ready():
	...
	pam.add_lf()
	pam.add_lf()
	pam.add_mover( test_helper___move2center_with_mainscene.scene_name(),	Key.KEY_Q, test_helper___move2center_with_mainscene.scene_path() )
	pam.add_mover( test_helper___move2center_with_viewport.scene_name(),	Key.KEY_W, test_helper___move2center_with_viewport.scene_path() )
	pam.add_mover( test_helper___move2center_with_camera2d.scene_name(),	Key.KEY_E, test_helper___move2center_with_camera2d.scene_path() )
	pam.add_mover( test_helper___move2center_with_canvaslayer.scene_name(),	Key.KEY_R, test_helper___move2center_with_canvaslayer.scene_path() )
	pam.add_mover( test_helper___move2center_with_control.scene_name(),		Key.KEY_T, test_helper___move2center_with_control.scene_path() )
	pam.add_mover( test_helper___drag.scene_name(),		Key.KEY_Y, test_helper___drag.scene_path() )
	pam.add_mover( test_helper___input.scene_name(),	Key.KEY_U, test_helper___input.scene_path() )
	pam.add_lf()
	pam.add_lf()
	...
	pam.add_lf()
	pam.add_lf()
	pam.add_mover( test_helper___scene_change.scene_name(),	Key.KEY_Z, test_helper___scene_change.scene_path() )
	pam.add_lf()
