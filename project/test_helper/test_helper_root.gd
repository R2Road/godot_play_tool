...
func _ready():
	...
	pam.add_lf()
	pam.add_lf()
	pam.add_mover( test_helper___move2center_root.scene_name(),	Key.KEY_Q, test_helper___move2center_root.scene_path() )
	pam.add_mover( test_helper___drag.scene_name(),				Key.KEY_W, test_helper___drag.scene_path() )
	pam.add_mover( test_helper___input.scene_name(),			Key.KEY_E, test_helper___input.scene_path() )
	pam.add_lf()
	pam.add_lf()
