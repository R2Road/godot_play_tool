...
func _ready():
	...
	pam.add_mover( test_helper___move2center_with_viewport.scene_name(),	Key.KEY_7, test_helper___move2center_with_viewport.scene_path() )
	pam.add_mover( test_helper___move2center_with_camera2d.scene_name(),	Key.KEY_8, test_helper___move2center_with_camera2d.scene_path() )
	pam.add_lf()
