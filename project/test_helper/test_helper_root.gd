...
func _ready():
	...
	pam.add_mover( test_helper___drag.scene_name(),		Key.KEY_T, test_helper___drag.scene_path() )
	pam.add_mover( test_helper___input.scene_name(),	Key.KEY_Y, test_helper___input.scene_path() )
	pam.add_lf()
	pam.add_lf()
